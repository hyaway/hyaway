...
const choiceBoxItemStyles = tv({
  base: [
    ...
    "inset-ring-border rounded-lg p-(--gutter) inset-ring **:data-[slot=label]:font-medium",
  ...
  variants: {
    ...
    isFocused: {
      true: "invalid:ring-danger-subtle-fg/20 ring-3 ring-(--choice-box-ring) inset-ring-(--choice-box-active-ring)",
    },
    isInvalid: { true: "ring-danger-subtle-fg/20 ring-3" },
    isOneColumn: {
      true: "col-span-full",
    },
    isActive: {
    ...
    isDisabled: {
      true: "**:data-[slot=label]:text-muted-fg **:[[slot=description]]:text-muted-fg/70 z-10 opacity-50 forced-colors:text-[GrayText]",
    },
  },
});
