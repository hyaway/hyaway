...
const dropdownItemStyles = tv({
  base: [
    ...
    "group text-fg relative cursor-default rounded-[calc(var(--radius-xl)-(--spacing(1)))] text-base/6 outline-0 select-none sm:text-sm/6",
    ...
    "[&_[data-slot='icon']:not([class*='text-'])]:text-muted-fg *:data-[slot=icon]:mr-(--mr-icon) **:data-[slot=icon]:h-5 **:data-[slot=icon]:w-5 **:data-[slot=icon]:shrink-0 has-[[slot=description]]:**:data-[slot=icon]:h-[1lh] sm:**:data-[slot=icon]:h-4 sm:**:data-[slot=icon]:w-4",
