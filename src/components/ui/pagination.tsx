...
const PaginationGap = ({
  ...
  return (
    <li
      ...
      className={twMerge(
        "text-fg w-9 text-center text-sm/6 font-semibold outline-hidden select-none",
        className,
      )}
      {...props}
      aria-hidden
...
const PaginationLabel = ({
  ...
  return (
    <li
      ...
      className={twMerge(
        "text-fg *:[strong]:text-fg min-w-4 self-center *:[strong]:font-medium",
        className,
      )}
      {...props}
    />
...
const PaginationInfo = ({ className, ...props }: React.ComponentProps<"p">) => {
  return (
    <p
      className={twMerge(
        "text-muted-fg *:[strong]:text-fg text-sm/6 *:[strong]:font-medium",
        className,
      )}
      {...props}
    />
